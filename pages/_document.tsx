      ...
      <Html>
        <Head>
          ...
          <meta
            ...
            content="Calcular resgate planejado do Nubank"
          />
          <meta
          ...
          <link
            ...
            type="image/png"
            sizes="512x512"
            href="/icons/logo/logo-512.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="384x384"
            href="/icons/logo/logo-384.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="192x192"
            href="/icons/logo/logo-192.png"
          />
          <link
            rel="icon"
            type="image/png"
          ...
          <link
            ...
            type="image/png"
            sizes="144x144"
            href="/icons/logo/logo-144.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="128x128"
            href="/icons/logo/logo-128.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="96x96"
            href="/icons/logo/logo-96.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="72x72"
            href="/icons/logo/logo-72.png"
          />
          <link
            rel="icon"
            type="image/png"
          ...
          <meta
            name="twitter:image"
            content="https://nucalc.vercel.app/icons/android-chrome-192x192.png"
          />
          ...
          <meta
            property="og:image"
            content="https://nucalc.vercel.app/icons/apple-touch-icon.png"
          />
          {/* END PWA DATA */}
